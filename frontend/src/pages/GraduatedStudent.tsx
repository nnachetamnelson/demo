// src/pages/GraduatedStudent.tsx
          ...
          <table className="min-w-full border-collapse">
            <thead>
              <tr className="text-gray-500 dark:text-gray-300 text-sm border-b border-gray-100 dark:border-gray-700">
                ...
                <th className="py-3 px-4 text-left">DATE ADMITTED</th>
                <th className="py-3 px-4 text-left">YEAR OF GRADUATION</th>
            ...
            <tbody>
              {filteredStudents.map((student, index) => (
                ...
                >
                  ...
                  {/* Actions */}
                  <td className="py-3 px-4">
                    <button onClick={() => navigate(`/student/${student.id}`, { state: { from: "GraduatedStudents" } })} className="bg-blue-100 text-blue-600 text-sm font-medium px-4 py-1 rounded-md shadow hover:bg-blue-200 transition">
                      View Student
                    </button>
                  </td>
                </tr>
