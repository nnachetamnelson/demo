    ...
    <Card className="p-6 bg-white rounded-2xl shadow-sm">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <Select value={category} onValueChange={setCategory}>
          ...
          <SelectContent>
            <SelectItem value="Senior School">Mock</SelectItem>
            <SelectItem value="Junior School">Regular</SelectItem>
            <SelectItem value="Primary School">Pre-SS1</SelectItem>
            <SelectItem value="Nursery School">Summer</SelectItem>
          </SelectContent>
        </Select>
      </div>
