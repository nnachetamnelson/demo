...
User.init(
  {
   ...
   schoolLogo: {
  type: DataTypes.TEXT, // allow very long strings
  allowNull: true,
  comment: "Base64 or URL of the school logo",
},
schoolSignature: {
  type: DataTypes.TEXT,
  allowNull: true,
  comment: "Base64 or URL of the school signature",
},
principalSignature: {
  type: DataTypes.TEXT,
  allowNull: true,
  comment: "Base64 or URL of the principal's signature",
},
